...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/flimblog/flimblogModule.js',
			'app/modules/flimblog/flimblogCtrl.js',
			'app/modules/flimblog/flimblogRoute.js',
			'app/modules/flimblog/flimblogService.js',
			'app/modules/flimblog/flimblog-test.js',
			'app/modules/movie1/movie1Module.js',
			'app/modules/movie1/movie1Ctrl.js',
			'app/modules/movie1/movie1Route.js',
			'app/modules/movie1/movie1Service.js',
			'app/modules/movie1/movie1-test.js',
		],
